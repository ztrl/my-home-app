...
const SkillContents = ({ activeContent }: ContentProps) => {
  const contents: { [key: string]: Array<SkillProps> } = {
    ...
    INFRA: [
      {
        name: "Docker ★☆☆☆☆",
        description: [
          "- 어플리케이션을 Docker 컨테이너로 띄워 주변 환경에 독립적으로 구동될 수 있도록 만들어 본 경험이 있습니다.",
        ],
      },
      {
        name: "Jenkins ★☆☆☆☆",
        description: [
          "- Jenkins Pipeline과 Docker를 같이 활용해서 CI/CD를 해본 경험이 있습니다.",
        ],
      },
      {
        name: "AWS ★★☆☆☆",
    ...
    TOOL: [
      ...
      {
        name: "Jira ★☆☆☆☆",
        description: ["- Jira 티켓을 발급해서 이슈 관리를 할 수 있습니다."],
      },
      {
        name: "Swagger ★★☆☆☆",
        description: [
